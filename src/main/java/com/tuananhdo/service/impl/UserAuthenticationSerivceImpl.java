...
import com.tuananhdo.util.ErrorMessageUtil;
import com.tuananhdo.util.ROLE;
...
public class UserAuthenticationSerivceImpl implements UserAuthenticationService {
    ...
    public UserAuthenticationSerivceImpl(UserRepository userRepository, PasswordEncoder passwordEncoder, RoleRepository roleRepository) {
