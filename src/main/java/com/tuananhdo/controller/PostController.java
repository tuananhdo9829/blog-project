...
import com.tuananhdo.util.SecurityUtils;
...
public class PostController {
    ...
    public PostController(PostService postService, CommentService commentService, FileUploadService fileUploadService) {
