...
import com.tuananhdo.dto.ForgotPasswordDTO;
...
public class ForgotPassowordController {
    ...
    public ForgotPassowordController(MailService mailService, UserAuthenticationService authenticationService, PathConfiguration pathConfiguration) {
